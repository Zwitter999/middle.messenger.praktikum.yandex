...
const messagesList: MessageProps[] = [
  ...
  { text: 'Как у тебя дела', author: 'ANONUMUS' },
  { text: 'У меня все хорошо это странно', author: 'ANONUMUS' },
  { text: 'Что странно?', author: 'ANONUMUS' },
  { text: 'Что мы общаемся на русском, а все приложение на английском', author: 'YOU' },
  { text: 'Ну да , просто автору было лень загонять этот текст в переводчик)', author: 'YOU' },
];
